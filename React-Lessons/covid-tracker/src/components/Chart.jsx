...
function BarChart({data}) {
  const selectedCountry = useSelector((state) => state.covidInfo.selectedCountry);
  const status = useSelector((state) => state.covidInfo.status);
  const countryData = useSelector((state) => state.covidInfo.countryData);
